...
if ( ! defined( 'ABSPATH' ) ) { exit; }
 ...
 if ( ! defined( 'ABSPATH' ) ) { exit; } $fs = freemius( $VARS['id'] ); $slug = $fs->get_slug(); $payments = $fs->_fetch_payments(); $show_payments = ( is_array( $payments ) && 0 < count( $payments ) ); if ( $show_payments ) : ?>
<div class="postbox">
	<div id="fs_payments">
