    ...
    (function( $ ) {
        ...
        function registerEventHandlers() {
            ...
            $modal.on('click', 'input[type="radio"]', function () {
                ...
                if ( isSelected ) {
                    $primaryButton.html( <?php echo json_encode( sprintf( fs_text_inline( 'Cancel %s & Proceed', 'cancel-x-and-proceed', $slug ), ucfirst( $subscription_cancellation_context ) ) ) ?> );
