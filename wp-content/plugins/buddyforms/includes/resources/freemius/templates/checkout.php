			...
			(function ($) {
				$(function () {
					...
					FS.PostMessage.receiveOnce('pending_activation', function (data) {
						...
						$.form('<?php echo fs_nonce_url( $fs->_get_admin_page_url( 'account', array( 'fs_action' => $fs->get_unique_affix() . '_activate_new', 'plugin_id' => $plugin_id, 'pending_activation' => true, ) ), $fs->get_unique_affix() . '_activate_new' ) ?>', requestData).submit();
					});
