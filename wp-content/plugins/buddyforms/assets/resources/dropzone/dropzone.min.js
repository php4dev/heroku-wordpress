...
else{r.push(undefined)}}}catch(n){u=!0;d=n}finally{try{if(!o&&l['return']!=null){l['return']()}}finally{if(u){throw d}}};return r}()}},{key:'_addFilesFromDirectory',value:function(e,t){var n=this,i=e.createReader(),r=function(e){return __guardMethod__(console,'log',function(t){return t.log(e)})},a=function l(){return i.readEntries(function(e){if(e.length>0){var o=!0,u=!1,d=undefined;try{for(var a=e[Symbol.iterator](),s;!(o=(s=a.next()).done);o=!0){var r=s.value;if(r.isFile){r.file(function(e){if(n.options.ignoreHiddenFiles&&e.name.substring(0,1)==='.'){return};e.fullPath=''.concat(t,'/').concat(e.name);return n.addFile(e)})}
...
else{e=[];var t=function(t){return function(){var r=[],a=!0,s=!1,u=undefined;try{for(var i=t[Symbol.iterator](),o;!(a=(o=i.next()).done);a=!0){var l=o.value;if(/(^| )dropzone($| )/.test(l.className)){r.push(e.push(l))}
else{r.push(undefined)}}}catch(n){s=!0;u=n}finally{try{if(!a&&i['return']!=null){i['return']()}}finally{if(s){throw u}}};return r}()};t(document.getElementsByTagName('div'));t(document.getElementsByTagName('form'))};return function(){var i=[],r=!0,o=!1,s=undefined;try{for(var n=e[Symbol.iterator](),l;!(r=(l=n.next()).done);r=!0){var a=l.value;if(Dropzone.optionsForElement(a)!==!1){i.push(new Dropzone(a))}
else{i.push(undefined)}}}catch(t){o=!0;s=t}finally{try{if(!r&&n['return']!=null){n['return']()}}finally{if(o){throw s}}};return i}()};Dropzone.blacklistedBrowsers=[/opera.*(Macintosh|Windows Phone).*version\/12/i];Dropzone.isBrowserSupported=function(){var t=!0;if(window.File&&window.FileReader&&window.FileList&&window.Blob&&window.FormData&&document.querySelector){if(!('classList' in document.createElement('a'))){t=!1}
else{var i=!0,a=!1,l=undefined;try{for(var n=Dropzone.blacklistedBrowsers[Symbol.iterator](),r;!(i=(r=n.next()).done);i=!0){var o=r.value;if(o.test(navigator.userAgent)){t=!1;continue}}}catch(e){a=!0;l=e}finally{try{if(!i&&n['return']!=null){n['return']()}}finally{if(a){throw l}}}}}
...
while(e=e.parentNode){if(e===t){return!0}};return!1};Dropzone.getElement=function(e,t){var n;if(typeof e==='string'){n=document.querySelector(e)}
else if(e.nodeType!=null){n=e};if(n==null){throw new Error('Invalid `'.concat(t,'` option provided. Please provide a CSS selector or a plain HTML element.'))};return n};Dropzone.getElements=function(e,t){var r,i;if(e instanceof Array){i=[];try{var s=!0,p=!1,h=undefined;try{for(var o=e[Symbol.iterator](),f;!(s=(f=o.next()).done);s=!0){r=f.value;i.push(this.getElement(r,t))}}catch(n){p=!0;h=n}finally{try{if(!s&&o['return']!=null){o['return']()}}finally{if(p){throw h}}}}catch(n){i=null}}
...
else if(e.nodeType!=null){i=[e]};if(i==null||!i.length){throw new Error('Invalid `'.concat(t,'` option provided. Please provide a CSS selector, a plain HTML element or a list of those.'))};return i};Dropzone.confirm=function(e,t,n){if(window.confirm(e)){return t()}
else if(n!=null){return n()}};Dropzone.isValidFile=function(e,t){if(!t){return!0};t=t.split(',');var o=e.type,d=o.replace(/\/.*$/,''),a=!0,s=!1,u=undefined;try{for(var r=t[Symbol.iterator](),l;!(a=(l=r.next()).done);a=!0){var i=l.value;i=i.trim();if(i.charAt(0)==='.'){if(e.name.toLowerCase().indexOf(i.toLowerCase(),e.name.length-i.length)!==-1){return!0}}
else if(/\/\*$/.test(i)){if(d===i.replace(/\/.*$/,'')){return!0}}
else{if(o===i){return!0}}}}catch(n){s=!0;u=n}finally{try{if(!a&&r['return']!=null){r['return']()}}finally{if(s){throw u}}};return!1};if(typeof jQuery!=='undefined'&&jQuery!==null){jQuery.fn.dropzone=function(e){return this.each(function(){return new Dropzone(this,e)})}};if(typeof module!=='undefined'&&module!==null){module.exports=Dropzone}
...
else{return a}},drawImageIOSFix=function(e,t,n,i,r,a,l,o,s,u){var d=detectVerticalSquash(t);return e.drawImage(t,n,i,r,a,l,o,s,u/d)},ExifRestore=function(){function e(){_classCallCheck(this,e)};_createClass(e,null,[{key:'initClass',value:function(){this.KEY_STR='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/='}},{key:'encode64',value:function(e){var o='',r=undefined,t=undefined,n='',s=undefined,u=undefined,a=undefined,i='',l=0;while(!0){r=e[l++];t=e[l++];n=e[l++];s=r>>2;u=(r&3)<<4|t>>4;a=(t&15)<<2|n>>6;i=n&63;if(isNaN(t)){a=i=64}
