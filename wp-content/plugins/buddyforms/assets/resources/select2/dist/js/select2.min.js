...
else{return(r[e]={})}},module:function(e){return{id:e,uri:'',exports:r[e],config:w(e)}}};c=function(e,n,i,s){var g,u,y,m,c,A,d=[],C=typeof i,w;s=s||e;A=E(s);if(C==='undefined'||C==='function'){n=!n.length&&i.length?['require','exports','module']:n;for(c=0;c<n.length;c+=1){m=h(n[c],A);u=m.f;if(u==='require'){d[c]=a.require(e)}
else if(u==='exports'){d[c]=a.exports(e);w=!0}
else if(u==='module'){g=d[c]=a.module(e)}
else if(o(r,u)||o(l,u)||o(f,u)){d[c]=p(u)}
else if(m.p){m.p.load(m.n,v(s,!0),D(u),{});d[c]=r[u]}
...
else{e.setAttribute('data-select2-id',++i);t=i.toString()}};return t};t.StoreData=function(e,n,i){var r=t.GetUniqueElementId(e);if(!t.__cache[r]){t.__cache[r]={}};t.__cache[r][n]=i};t.GetData=function(n,i){var r=t.GetUniqueElementId(n);if(i){if(t.__cache[r]){return t.__cache[r][i]!=null?t.__cache[r][i]:e(n).data(i)};return e(n).data(i)}
...
else{e.first().trigger('mouseenter')};this.ensureHighlightVisible()};n.prototype.setClasses=function(){var n=this;this.data.current(function(i){var r=e.map(i,function(e){return e.id.toString()}),s=n.$results.find('.select2-results__option[aria-selected]');s.each(function(){var i=e(this),n=t.GetData(this,'data'),s=''+n.id;if((n.element!=null&&n.element.selected)||(n.element==null&&e.inArray(s,r)>-1)){i.attr('aria-selected','true')}
...
else if(s>i){r.$results.scrollTop(o)}});n.on('results:focus',function(e){e.element.addClass('select2-results__option--highlighted')});n.on('results:message',function(e){r.displayMessage(e)});if(e.fn.mousewheel){this.$results.on('mousewheel',function(e){var t=r.$results.scrollTop(),n=r.$results.get(0).scrollHeight-t+e.deltaY,i=e.deltaY>0&&t-e.deltaY<=0,s=e.deltaY<0&&n<=r.$results.height();if(i){r.$results.scrollTop(0);e.preventDefault();e.stopPropagation()}
else if(s){r.$results.scrollTop(r.$results.get(0).scrollHeight-r.$results.height());e.preventDefault();e.stopPropagation()}})};this.$results.on('mouseup','.select2-results__option[aria-selected]',function(n){var s=e(this),i=t.GetData(this,'data');if(s.attr('aria-selected')==='true'){if(r.options.get('multiple')){r.trigger('unselect',{originalEvent:n,data:i})}
...
else{s=i.GetData(e[0])};var r=t.extend(!0,{},s);r=i._convertData(r);for(var n in r){if(t.inArray(n,o)>-1){continue};if(t.isPlainObject(this.options[n])){t.extend(this.options[n],r[n])}
...
else if(t.removedNodes&&t.removedNodes.length>0){n=!0};if(n){this.dataAdapter.current(function(e){s.trigger('selection:update',{data:e})})}};i.prototype.trigger=function(e,t){var r=i.__super__.trigger,s={'open':'opening','close':'closing','select':'selecting','unselect':'unselecting','clear':'clearing'};if(t===undefined){t={}};if(e in s){var o=s[e],n={prevented:!1,name:e,args:t};r.call(this,o,n);if(n.prevented){t.prevented=!0;return}};r.call(this,e,t)};i.prototype.toggleDropdown=function(){if(this.options.get('disabled')){return};if(this.isOpen()){this.close()}
...
else if(typeof t==='string'){var i,o=Array.prototype.slice.call(arguments,1);this.each(function(){var e=r.GetData(this,'select2');if(e==null&&window.console&&console.error){console.error('The select2(\''+t+'\') method was called on an element that is not using Select2.')};i=e[t].apply(e,o)});if(e.inArray(t,s)>-1){return this};return i}
