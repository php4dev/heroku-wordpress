...
function($) {
    ...
    _.isUndefined(window.vc) && (window.vc = {}), vc.showSpinner = function() {
        ...
        buildParamsContent: function(data) {
            ...
            window.vc_presets_show && this.$el.find('[data-vc-ui-element="settings-dropdown"]').show(), 
        ...
        var GoogleFonts = Backbone.View.extend({
            ...
            VC_AutoComplete = Backbone.View.extend({
                ...
                createBox: function(item) {
                    ...
                    this.updateItems(), $label = $('<li class="vc_autocomplete-label vc_data" data-index="' + index + '" data-value="' + item.value + '" data-label="' + item.label + '"><span class="vc_autocomplete-label"><a>' + item.label + "</a></span>" + remove + "</li>"),
                        $label.insertBefore(this.$el_wrap), this.labelRemoveHook($label)
                },
        ...
        window.VcRowView = vc.shortcode_view.extend({
            ...
            changeShortcodeParams: function(model) {
                ...
                window.VcCallToActionView.__super__.changeShortcodeParams.call(this, model),
                    params = model.get("params"), _.isObject(params) && _.isString(params.position) && this.$el.find("> .wpb_element_wrapper").removeClass(_.values(this.params.position.value).join(" ")).addClass(params.position)
            }
