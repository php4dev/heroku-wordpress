...
final class Message
{
     ...
     * @return string
     */
    public static function toString(\Google\Site_Kit_Dependencies\Psr\Http\Message\MessageInterface $message)
    {
     ...
     * @return string|null
     */
    public static function bodySummary(\Google\Site_Kit_Dependencies\Psr\Http\Message\MessageInterface $message, $truncateAt = 120)
    {
